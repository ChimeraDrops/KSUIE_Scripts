...
RegisterNetEvent('ksuie_robbery:client:SetStationStatus')
AddEventHandler('ksuie_robbery:client:SetStationStatus', function(key, isHit)
...
RegisterNUICallback('thermitesuccess', function()
    ...
    if currentStation ~= 0 then
        ...
        TriggerServerEvent("ksuie_robbery:server:SetStationStatus", currentStation, true)
