...
Config.MarkedBillsSmallBank = math.random(1000, 2000)
Config.MarkedBillsPaletoBank = math.random(3000, 5000)
Config.MarkedBillsPacificBank = math.random(6000, 20000)
